...
INBOUND_NR_TRACESTATE = (
    "1@nr=0-0-1349956-41346604-27ddd2d8890283b4-b28be285632bbc0a-" "1-1.4-1569367663277"
)
INBOUND_NR_TRACESTATE_UNSAMPLED = (
    "1@nr=0-0-1349956-41346604-27ddd2d8890283b4-b28be285632bbc0a-" "0-0.4-1569367663277"
)
...
def test_inbound_traceparent_header(traceparent, intrinsics, metrics):
    ...
    def _test():
        test_asgi_application.make_request(
            "GET", "/", headers={"traceparent": traceparent}
        )
...
@pytest.mark.parametrize(
    ...
    (
        (
            INBOUND_TRACESTATE,
            {"tracingVendors": "rojo,congo", "parentId": "00f067aa0ba902b7"},
        ),
