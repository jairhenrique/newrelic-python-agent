...
_stack_trace_inline = _format_stack_trace_from_tuples(
    [
        (
            __file__,
            test_trace_inline.__code__.co_firstlineno + 2,
...
_stack_trace_passed1 = _format_stack_trace_from_tuples(
    [
        (
            __file__,
            test_trace_passed1.__code__.co_firstlineno + 2,
            test_trace_passed1.__name__,
        ),
        (
            __file__,
            _test_trace_passed1.__code__.co_firstlineno + 2,
...
_stack_trace_passed2 = _format_stack_trace_from_tuples(
    [
        (
            __file__,
            test_trace_passed2.__code__.co_firstlineno + 2,
            test_trace_passed2.__name__,
        ),
        (
            __file__,
            _test_trace_passed2a.__code__.co_firstlineno + 2,
