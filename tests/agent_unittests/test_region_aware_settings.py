...
def test_region_aware_license_keys(
    ini, env, expected_host, expected_license_key, global_settings
):
...
def test_region_aware_global_settings(
    ini, license_key, host_override, expected_host, global_settings
):
    settings = global_settings()
