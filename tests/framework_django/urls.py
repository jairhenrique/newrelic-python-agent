...
urlpatterns = [
    ...
    url(
        r"^html_insertion_content_length$",
        views.html_insertion_content_length,
        name="html_insertion_content_length",
    ),
    url(
        r"^html_insertion_manual$",
        views.html_insertion_manual,
    ...
    url(
        r"^render_exception_function",
        views.render_exception_function,
        name="render_exception_function",
    ),
    url(
        r"^render_exception_class",
        views.RenderExceptionClass.as_view(),
