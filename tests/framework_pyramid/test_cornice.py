...
@validate_transaction_metrics(
    "_test_application:cornice_service_get_info",
...
@validate_transaction_errors(errors=[])
@validate_transaction_metrics(
    "_test_application:Resource.collection_get",
...
@validate_transaction_errors(errors=[])
@validate_transaction_metrics(
    "_test_application:Resource.get",
...
@validate_transaction_metrics(
    "_test_application:cornice_error_get_info",
