...
def validate_internal_metrics(metrics=None):
    ...
    def _validate_wrapper(wrapped, instance, args, kwargs):
        ...
        wrapped = transient_function_wrapper(
            "newrelic.core.internal_metrics", "InternalTraceContext.__enter__"
        )(no_op)(wrapped)
        wrapped = transient_function_wrapper(
            "newrelic.core.internal_metrics", "InternalTraceContext.__exit__"
        )(no_op)(wrapped)
